...
public class Constants {
    public static final String BD_EXIT_APP = com.travel.Constants.ACTION_LOGIN;
...
//    public static final int SDK_APPID = 1400001533;
    ...
    public static int SDK_APPID = 1400013400 /*1400015172*/;

    public static int ACCOUNT_TYPE = 7112; /*7703;*/
    ...
    public static final int AVIMCMD_MUlTI_USER_APPLY_INSERT = AVIMCMD_MULTI + 1;         // 多人主播发送邀请消息, C2C消息
    public static final int AVIMCMD_MULTI_CANCEL_INTERACT = AVIMCMD_MUlTI_USER_APPLY_INSERT + 1;       // 断开互动，Group消息，带断开者的imUsreid参数
    ...
    public static final int AVIMCMD_MULTI_MY = 0x900; // 中旅传媒自定义部分
    public static final int AVIMCMD_RECEIVE_INSERT_LINE = AVIMCMD_MULTI_MY + 1; // 同意插播
    public static final int AVIMCMD_CANCEL_INSERT_LINE = AVIMCMD_MULTI_MY + 2; // 取消插播
    ...
    public static final int AVIMCMD_SEND_GIFT = AVIMCMD_Host_Back + 1;      // 发送礼物

    // PK部分的消息
    public static final int AVIMCMD_PK_INDEX = 0x1000; // pk部分命令的开始部分
    public static final int AVIMCMD_PK_USER_START_LIVE = AVIMCMD_PK_INDEX; // 有用户开始直播
    public static final int AVIMCMD_PK_USER_STOP_LIVE = AVIMCMD_PK_USER_START_LIVE + 1; // 用户结束直播
    ...
    public static final long NORMAL_MEMBER_AUTH
    ...
    public static void initAppIdAndType(int appId, int type){
        SDK_APPID = appId;
        ACCOUNT_TYPE = type;
    }
}
