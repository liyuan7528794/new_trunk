...
public class AdapterJoiner {
    ...
    public interface Joinable{
        ...
        /**
         * 返回当前Joinable对象的type种类
         */
        int getTypeCount();

        /**
         * 获取对应位置的type数值
         * {@code typeIndex} 从0 --> Joinable.getTypeCount
         */
        int getTypeByIndex(int typeIndex);
    }

    @VisibleForTesting ShadowAdapter mShadowAdapter = new ShadowAdapter();
    @VisibleForTesting Map<Joinable, DataObserver> mJoinableToDataObserver = new HashMap<>();
...
//            onChanged();
        ...
        private int getJoinedPosition(int realPos){
            return AdapterJoiner.this.getJoinedPosition(mDataObserverToJoinable.get(this), realPos);
        }
    }
}
