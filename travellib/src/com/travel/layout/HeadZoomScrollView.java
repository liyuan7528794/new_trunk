...
public class HeadZoomScrollView extends ScrollView {
    ...
    //    放大的view，默认为第一个子view
    private View zoomView, arcView;

    public void setZoomView(View zoomView) {
        this.zoomView = zoomView;
    }

    public void setZoomViewArc(View arcView) {
    ...
    private void setZoom(float s) {
        ...
        LinearLayout.LayoutParams arcParams = (LinearLayout.LayoutParams) arcView.getLayoutParams();
        arcParams.topMargin = layoutParams.height - OSUtil.dp2px(getContext(), 9);
        arcView.setLayoutParams(arcParams);
    }
    ...
    private void replyView() {
        ...
        anim.start();
        LinearLayout.LayoutParams arcParams = (LinearLayout.LayoutParams) arcView.getLayoutParams();
        arcParams.topMargin = OSUtil.dp2px(getContext(), 139);
        arcView.setLayoutParams(arcParams);
    }
