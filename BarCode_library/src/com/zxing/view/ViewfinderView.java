...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        maskColor = resources.getColor(R.color.black_alpha30);
        resultColor = resources.getColor(R.color.black_alpha70);
        frameColor = resources.getColor(R.color.viewfinder_frame);
        laserColor = resources.getColor(R.color.viewfinder_laser);
        resultPointColor = resources.getColor(R.color.red_FF2942_alpha50);
        scannerAlpha = 0;
        possibleResultPoints = new HashSet<ResultPoint>(5);

        mRect = new Rect();
        int left = getResources().getColor(R.color.lightgreen);
        int center = getResources().getColor(R.color.green_21C700);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            // 画出四个角
            paint.setColor(getResources().getColor(R.color.green_21C700));
            // 左上角
