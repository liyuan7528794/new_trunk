...
public class FilterMenuLayout extends ViewGroup {
    ...
    public static final int DURATION_ADD = 150;
    private static final int DURATION_BETWEEN_ITEM = 20;
    private static final int DURATION_BETWEEN_ITEM_ADD = 10;
    /**
    ...
    private void init(Context ctx, AttributeSet attrs) {
        ...
        primaryColor = ta.getColor(R.styleable.FilterMenuLayout_fm_primaryColor, ContextCompat.getColor(ctx, android.R.color.transparent));
        primaryDarkColor = ta.getColor(R.styleable.FilterMenuLayout_fm_primaryDarkColor, ContextCompat.getColor(ctx, android.R.color.transparent));
        ta.recycle();
    ...
    void startExpandAnimation() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            getChildAt(i).animate()
                    ...
                    .alpha(1f)
                    .start();
            delay += DURATION_BETWEEN_ITEM_ADD;
        }
    }
