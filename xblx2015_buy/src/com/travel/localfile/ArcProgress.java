...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = OSUtil.dp2px(context, 18);
        min_size = (int) OSUtil.dp2px(context, 100);
        default_text_size = OSUtil.dp2px(context, 40);
        default_suffix_text_size = OSUtil.dp2px(context, 15);
        default_suffix_padding = OSUtil.dp2px(context, 4);
        default_suffix_text = "%";
        default_bottom_text_size = OSUtil.dp2px(context, 10);
        default_stroke_width = OSUtil.dp2px(context, 4);
...
//        textColor = attributes.getColor(R.styleable.ArcProgress_arc_text_color, default_text_color);
        textColor = attributes.getColor(R.styleable.ArcProgress_arc_text_color, ContextCompat.getColor(getContext(), android.R.color.white));
