 ...
 * 
 */
public class LiveDetailsViewActivity extends TitleBarBaseActivity {
	...
	private void init() {
		...
		newDetailsList = new ArrayList<DetailsViewBean>();
		detailsList = new ArrayList<DetailsViewBean>();
	...
	private void getDetails() {
		...
		map.put("times", mPage);
		NetWorkUtil.postForm(mContext, ShopConstant.LIVE_INCOME_LIST, new MResponseListener(mContext) {
